...
#import "HXGLongPDFControl.h"

@interface HXGLongPDFControl ()

@end

@implementation HXGLongPDFControl

+ (id) sharedPDFControl {
    
    static dispatch_once_t pred;
    static HXGLongPDFControl * thePDFControl = nil;
    
    dispatch_once(&pred, ^{ thePDFControl = [[self alloc] init]; });
    return thePDFControl;
