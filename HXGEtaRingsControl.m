...
- (void)windowDidLoad {
    ...
    wRect.origin = NSMakePoint(200.,[[NSScreen mainScreen] frame].size.height-height-42.0);
    ...
    NSRect brect = NSMakeRect(10.,10.,175.,20.);
    ...
    for (int i=0;i<8;i++) {
        ...
        [[etaSegs[i] cell] setFont:[NSFont systemFontOfSize:10]];
